...
@hydra_runner(config_path="conf", config_name="ptune_inference.yaml")
def main(cfg) -> None:
    ...
    while True:
        inputs = input("Bot Prompt:")
        #inputs = {"taskname": "instruct", "user_input":inputs}
        inputs = {"taskname": "general_dialogue", "input_seq":inputs}
        terminal_input = [inputs]
